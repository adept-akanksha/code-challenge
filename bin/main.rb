require_relative '../lib/html_builder'
...
# Call class to build highlighted html and
# save in the output file in the root directory
puts "*" * 50
HtmlBuilder.new(content, highlights).call
puts "*" * 50
